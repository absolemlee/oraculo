      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        ...
        {activeTab === 'ifa' && (
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Ifá Correspondence Reading</CardTitle>
                <CardDescription>
                  Discover the Ifá odù corresponding to I-Ching hexagrams with traditional Yoruba wisdom
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button onClick={getIfaReading} disabled={loading} className="w-full">
                  {loading ? 'Consulting Ifá...' : 'Get Ifá Reading'}
                </Button>
              </CardContent>
            </Card>
            ...
            {ifaReading && !loading && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end justify-center z-50">
                <div className="bg-white rounded-t-xl shadow-xl w-full max-w-4xl max-h-[85vh] overflow-y-auto animate-slide-up">
                  <div className="sticky top-0 bg-white border-b p-4 flex justify-between items-center rounded-t-xl">
                    <div className="flex flex-col items-center w-full">
                      <div className="w-12 h-1 bg-gray-300 rounded-full mb-3"></div>
                      <h2 className="text-lg sm:text-xl font-semibold text-center">Ifá Correspondence Reading</h2>
                    </div>
                    <Button 
                      variant="ghost" 
                      size="sm" 
                      onClick={() => setIfaReading(null)}
                      className="text-slate-500 hover:text-slate-700 absolute right-4"
                    >
                      ✕
                    </Button>
                  </div>
        ...
        {activeTab === 'lookup' && (
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Hexagram Lookup</CardTitle>
                <CardDescription>
                  Look up any of the 64 hexagrams by number to study their meaning
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2">Hexagram Number (1-64)</label>
                  <Input
                    type="number"
                    min="1"
                    max="64"
                ...
                <Button onClick={getHexagramDetails} disabled={loading} className="w-full">
                  {loading ? 'Looking up hexagram...' : 'Get Hexagram Details'}
                </Button>
              </CardContent>
            </Card>
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end justify-center z-50">
                <div className="bg-white rounded-t-xl shadow-xl w-full max-w-4xl max-h-[85vh] overflow-y-auto animate-slide-up">
                  <div className="sticky top-0 bg-white border-b p-4 flex justify-between items-center rounded-t-xl">
                    <div className="flex flex-col items-center w-full">
                      <div className="w-12 h-1 bg-gray-300 rounded-full mb-3"></div>
                      <h2 className="text-lg sm:text-xl font-semibold text-center">Hexagram Details</h2>
                    </div>
                    <Button 
                      variant="ghost" 
                      size="sm" 
